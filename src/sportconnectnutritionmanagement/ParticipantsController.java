...
private void OnDownload(ActionEvent event) throws IOException, DocumentException {
    ...
    Document document = new Document();
        ...
        PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\aymen\\OneDrive\\Documents\\NetBeansProjects\\sportConnectNutritionManagement\\src\\images\\Participants.pdf"));
        document.open();
...
if (printerJob != null) {
    ...
    File file = new File("C:\\Users\\aymen\\OneDrive\\Documents\\NetBeansProjects\\sportConnectNutritionManagement\\src\\images\\Participants.pdf");
    ...
    Parent root = FXMLLoader.load(getClass().getResource("SupprimerCategorie.fxml"));
    Scene scene = new Scene(root);
    ...
    Parent root = FXMLLoader.load(getClass().getResource("AfficherEven.fxml"));
    Scene scene = new Scene(root);
    Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    stage.setScene(scene);
    stage.show();
